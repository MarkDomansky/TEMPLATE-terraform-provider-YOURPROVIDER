...
#
# Contract: do not write to the error stream (that fails provider startup) and
# pipe any unwanted cmdlet output to Out-Null. Globals you create here persist
# for every resource script because the PowerShell process is persistent.
